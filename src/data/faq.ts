...
export const faqItems: FaqItem[] = [
  ...
  },
  {
    ...
    answer:
      "60分・¥3,000（前払い）です。お申し込みフォーム送信時に Stripe 決済を経由します（決済完了をもって申し込み確定）。本気で受験と向き合う方に集中するための軽い参加コストとして設定しています。60分まるごと、講師（森祐太）が苦手調査・REM 演習プリントを使った授業・質疑応答・学習方針の提案までを担当します。",
  },
  {
    category: "体験授業",
