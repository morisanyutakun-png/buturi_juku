...
export const faqItems: FaqItem[] = [
  ...
  },
  {
    ...
    answer:
      "60分・¥3,000（前払い）です。冷やかしを避け、本気で受験と向き合う方に集中するための軽い参加コストとして設定しています。60分まるごと、講師（森祐太）が現状診断・診断ミニ授業・学習戦略提案まで担当します。",
  },
  {
    category: "体験授業",
  ...
  },
  {
    ...
    answer:
      "はい、Solvora の主力動線です（体験 → 電磁気集中 → 1対1個別）。体験授業の後半 30分で、書籍著者本人が担当する電磁気集中講座と同じ思考順序を圧縮して試せます。受講のスタートタイミングは体験中にご相談します。",
  },
  {
    category: "料金",
