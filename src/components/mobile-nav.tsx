...
export function MobileNav() {
  ...
  // The drawer is rendered via portal to <body> so it escapes the header's
  // stacking context (header has backdrop-blur, which would otherwise trap
  // z-index inside it and hide the drawer behind page content).
  const drawer = (
    <div
