...
const intents = [
  {
    ...
    body: "総合塾の進度に合わせるのではなく、志望校の出題傾向・残り期間・今の理解度から、物理だけの学習ルートを設計します。",
    href: "/courses/private",
    cta: "1対1個別指導を見る",
  },
  {
    icon: MonitorCheck,
    keyword: "オンライン 物理 個別指導",
    title: "通塾せず、全国どこからでも1対1で学びたい",
    body: "ライブ授業の手書きボード、授業録画、質問チャットを組み合わせて、オンラインでも思考の詰まりまで見える指導を行います。",
    href: "/about",
    cta: "塾の特徴を見る",
  },
  {
    ...
    body: "公式暗記ではなく、リード文・グラフ・選択肢を読み解く処理手順を身につけ、時間配分まで含めて対策します。",
    href: "/courses/kyotsu",
    cta: "共通テスト対策を見る",
  },
  {
    ...
    title: "力学・電磁気など、苦手分野だけを短期で立て直したい",
    body: "物理の失点原因を分野別に切り分け、力学の立式、電磁気の場のイメージなど、必要な単元に絞って補強します。",
    href: "/courses",
    cta: "分野別講座を見る",
  },
] as const;
...
export function SeoIntentSection() {
  return (
    <Section
      ...
      title={<>検索で探される悩みに、<br className="sm:hidden" />専門塾として答えます。</>}
      description="広告から来た方にも、自然検索で調べている方にも、迷わず次の一歩を選べるようにしています。物理の悩みは、目的別に整理すると対策が明確になります。"
