...
const rows: { label: string; value: string }[] = [
  ...
  },
  {
    label: "支払時期",
    value:
      "体験授業（¥3,000）はお申し込みフォーム送信時に Stripe 決済で前払いいただきます。本講座はすべて、体験授業後にお送りする支払いフォームでご入金（受講開始前の一括前払い）いただきます。入金確認をもって正式にお申し込み完了となります。",
  },
  {
    label: "役務の提供時期",
    value: "本講座は、入金確認後に日程調整を行い、ご都合に合わせた日程で順次開始します。",
  },
  {
    label: "返品・キャンセル",
    value:
