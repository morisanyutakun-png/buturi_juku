  ...
  return (
    <>
      <PageHero
        ...
        description="Solvora Learning Lab の体験授業は、入塾を前提としない学習相談としてご利用いただけます。本気で受験と向き合う方への軽い参加コストとして ¥3,000 をいただき、現状の苦手分野と残り期間を踏まえた学習戦略を、講師（森祐太）が直接お渡しします。一番おすすめしているのは、書籍ベースの電磁気集中講座。さらに専用カリキュラムが必要な方には、1対1 専用カリキュラム指導もご案内します。"
      >
      ...
      <JsonLd
        ...
        data={webPageJsonLd({
          ...
          description:
            "Solvora Learning Lab の60分・¥3,000 体験授業。現在の高校物理の理解度を診断し、学習戦略とおすすめコース（電磁気集中講座 / 1対1 専用カリキュラム指導）を提案します（高校物理専門塾としての指導継続）。",
          path: "/trial",
        })}
      />
      <JsonLd
